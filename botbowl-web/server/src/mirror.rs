...
pub fn skill_label(s: et::Skill) -> &'static str {
    match s {
        ...
        et::Skill::JumpUp => "Jump Up",
        et::Skill::Leap => "Leap",
        et::Skill::SideStep => "Side Step",
        et::Skill::Sprint => "Sprint",
        et::Skill::SureFeet => "Sure Feet",
        et::Skill::DirtyPlayer => "Dirty Player",
        et::Skill::PileDriver => "Pile Driver",
        et::Skill::QuickFoul => "Quick Foul",
        et::Skill::Shadowing => "Shadowing",
        et::Skill::SneakyGit => "Sneaky Git",
        et::Skill::Block => "Block",
        et::Skill::Dauntless => "Dauntless",
        et::Skill::Fend => "Fend",
        et::Skill::Frenzy => "Frenzy",
        et::Skill::Kick => "Kick",
        ...
        et::Skill::OnTheBall => "On the Ball",
        et::Skill::Pass => "Pass",
        et::Skill::ArmBar => "Arm Bar",
        et::Skill::Brawler => "Brawler",
        et::Skill::BreakTackle => "Break Tackle",
        et::Skill::Grab => "Grab",
        et::Skill::Guard => "Guard",
        et::Skill::Juggernaut => "Juggernaut",
        et::Skill::MightyBlow => "Mighty Blow",
        et::Skill::StandFirm => "Stand Firm",
        et::Skill::BoneHead => "Bone Head",
        et::Skill::Loner => "Loner",
        et::Skill::Stunty => "Stunty",
        et::Skill::Throw => "Throw",
        et::Skill::WildAnimal => "Wild Animal",
        et::Skill::KickOffReturn => "Kick-Off Return",
    }
}
