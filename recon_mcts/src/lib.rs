...
//!
//! This crate provides a flexible and efficient implementation of MCTS for various discrete move games.
...
pub mod prelude {
    ...
    pub use crate::tree::{
        ArcNode, ArcWrap, Node, NodeInfo, OnDrop, RecombinationStats, RegistryInfo, SearchTree, Status, Tree, WeakNode,
        WeakWrap,
    };
